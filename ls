...
DDEESSCCRRIIPPTTIIOONN
       This manual page documents the GNU version of cchhoowwnn.  cchhoowwnn changes the
       ...
       cchhoowwnn  performs  the same function as cchhggrrpp.  If only a colon is given,
       or if the entire operand is empty, neither the owner nor the  group  is
       changed.

OOPPTTIIOONNSS
       Change the owner and/or group of each FILE to OWNER and/or GROUP.  With
       ----rreeffeerreennccee, change the owner and group of each FILE to those of RFILE.
